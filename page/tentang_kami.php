...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Office Location
    const officeMarker = L.marker([-7.4246, 109.2379], {icon: officeIcon}).addTo(map);
    ...
    const customerLocations = [
        {lat: -7.4180, lng: 109.2450, name: 'Pak Budi', area: 'Purwokerto Utara', product: 'Silika V-0D01'},
        {lat: -7.4310, lng: 109.2280, name: 'Bu Siti', area: 'Purwokerto Barat', product: 'Tera Nusa Maxi-D'},
        {lat: -7.4200, lng: 109.2500, name: 'Pak Ahmad', area: 'Purwokerto Timur', product: 'Tera Nusa Hama'},
        {lat: -7.4350, lng: 109.2450, name: 'Pak Joko', area: 'Kembaran', product: 'Silika V-0D01'},
        {lat: -7.4150, lng: 109.2300, name: 'Bu Ani', area: 'Sokaraja', product: 'Tera Nusa Maxi-B'},
        {lat: -7.4280, lng: 109.2520, name: 'Pak Dedi', area: 'Purwokerto Selatan', product: 'Tera Nusa Silika Cair'},
        {lat: -7.4100, lng: 109.2400, name: 'Bu Ratna', area: 'Purwokerto Utara', product: 'Tera Nusa Maxi-D'},
        {lat: -7.4380, lng: 109.2350, name: 'Pak Hendra', area: 'Banyumas', product: 'Silika V-0D01'},
        {lat: -7.4220, lng: 109.2180, name: 'Bu Dewi', area: 'Sokaraja Barat', product: 'Tera Nusa Hama'},
        {lat: -7.4320, lng: 109.2580, name: 'Pak Agus', area: 'Purwokerto Timur', product: 'Tera Nusa Maxi-B'}
    ];

    // Add customer markers
    customerLocations.forEach(function(customer) {
        const marker = L.marker([customer.lat, customer.lng], {icon: customerIcon}).addTo(map);
        marker.bindPopup(`
